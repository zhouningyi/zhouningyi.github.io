...
;(function (name, definition) {
   ...
   */
   var Line = DataV.extend(DataV.Chart, {
    initialize: function (node, options) {
      ...
      //Properties
      this.defaults.margin = [40, 40, 40, 40];
      ...
      this.defaults.xAxisFontSize = 14;
      this.defaults.yAxisFontSize = 14;
      ...
      this.defaults.AxisColor = "#999";
      this.defaults.gridColor = "#555";
  ...
  Line.prototype.setXaxis = function (titles) {
    ...
    if (conf.hasXAxis) {
      ...
      xAxisText.attr({"font-size": fontSize,"fill":"#888"});
      this.xAxis = xAxis;
      this.xGrid = xGrid;
  ...
  Line.prototype.setYaxis = function () {
    ...
    if (conf.hasYAxis) {
      ...
      yAxisText.attr({"font-size": fontSize,"fill":"#888","font-weight":"bold"});
      this.yAxis = yAxis;
      this.yGrid = yGrid;
  ...
  Line.prototype.render = function () {
    ...
    this.setBackground();
    var lineColor = conf.lineColor;
    var nodeColor = conf.nodeColor;
    ...
    linesData.forEach(function (d, i) {
      ...
      for (var j = 0, l = nodeData.length; j < l; j++) {
        ...
        if (nodeMode) {
          var thisNode = canvas.circle(x, y, radius * 2).attr({fill: nodeColor[i], "stroke": "#fff","stroke-width":2});
          thisNode.data('num', j);
      ...
      lines.push(canvas.path(linePath).attr({"stroke": lineColor[i], "stroke-width": lineSize}).data('num', i));
      if (nodeMode) {
